<template>
  <UPage class="m-0 p-0 bg-(--color-jm-secondary-white)">
    <UPageBody
        class="prose-h1:normal-case prose-h1:py-4 prose-h1:font-bold prose-h1:text-4xl prose-h3:normal-case prose-h3:py-4 prose-h3:font-bold prose-h3:text-2xl prose-p:leading-7  prose-headings:uppercase prose-lead:uppercase prose-lead:text-base"
        prose>
      ...
      <UContainer class="max-w-(--container-2xl) py-10">
        ...
        <p>
          <span>Zusätzlich verarbeiten wir<br>
        ...
        <h3>Hosting</h3>
        <p>
          <span>Die von uns in Anspruch genommenen Hosting-Leistungen dienen der
            ...
            28 DSGVO (Abschluss Auftragsverarbeitungsvertrag).</span>
        </p>
        <h3>Erhebung von Zugriffsdaten und Logfiles</h3>
        <p>
          <span>Wir, bzw. unser Hostinganbieter, erhebt auf Grundlage unserer
        ...
        <p>
          <span>Wir verarbeiten die Daten unserer Kunden im Rahmen unserer
        ...
        <p>
          <span>Wir verarbeiten Bestandsdaten (z.B., Namen und Adressen sowie
            ...
            Eingaben, sind für den Vertragsschluss erforderlich.<br>
            <br>
            ...
            verbleiben bis zu dessen Löschung.</span>
        </p>
        <h3>
        ...
        <p>
          <span>Wir verarbeiten Daten im Rahmen von Verwaltungsaufgaben sowie
        ...
        <p>
          <span>Wir verarbeiten die Bewerberdaten nur zum Zweck und im Rahmen des
            ...
            Datenschutzerklärung dargelegten Art und Umfang einverstanden.<br>
            <br>
            ...
            für die Berufsausübung erforderlich sind).<br>
            <br>
            ...
            verschlüsselt an uns übertragen.<br>
            ...
            entsprechend den steuerrechtlichen Vorgaben archiviert.<br>
          </span>
        </p>
        <h3>Kontaktaufnahme</h3>
        <p>
          <span>Bei der Kontaktaufnahme mit uns (z.B. per Kontaktformular,
            ...
            gelten die gesetzlichen Archivierungspflichten.</span>
        </p>
        <h3>Onlinepräsenzen in sozialen Medien</h3>
        <p>
          <span>Wir unterhalten Onlinepräsenzen innerhalb sozialer Netzwerke und
            ...
            oder uns Nachrichten zusenden.</span>
        </p>
        <h3>Einbindung von Diensten und Inhalten Dritter</h3>
        <p>
          <span>Wir setzen innerhalb unseres Onlineangebotes auf Grundlage
