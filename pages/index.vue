<template>
  <UPage>
    <UPageBody class="m-0 p-0 text-center">
      <div class="relative bg-(--jm-secondary-grey-lighter)">
        <UContainer
            class="relative h-screen z-10 ">
      ...
      <div class="relative bg-(--color-jm-primary-green) text-left">
        ...
        <UContainer id="machen" class="relative py-10">
      ...
      <UContainer class="max-w-(--container-2xl) relative py-4 text-left">
      ...
      <div class="relative">
        ...
        <UContainer class="max-w-(--container-4xl) relative py-10 md:mb-40 z-10">
          <ImageFigure
      ...
      <UContainer class="max-w-(--container-2xl) relative py-10 z-10">
        <UButton
            color="secondary"
      ...
      <div class="relative bg-(--color-jm-primary-green) mt-64">
        ...
        <UContainer class="max-w-(--container-2xl) relative py-10">
