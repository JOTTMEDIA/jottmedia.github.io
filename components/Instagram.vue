<template>
  <div class="text-center mb-8">
    <NuxtLink href="https://www.instagram.com/jott.media/" target="_blank" class="inline-block"><UIcon class="text-jm-primary-green text-[70px]" name="i-mdi-instagram" /></NuxtLink>
  </div>
...
const posts = ref<InstagramPosts[]>([
  {
    id: '1',
    src: '1-instagram.jpg',
    link: 'https://www.instagram.com/jott.media/',
