      ...
      <UContainer :ui="{'constrained': 'max-w-2xl'}" class="relative py-10 z-10">
        <div class="flex justify-between items-end">
          ...
          <div class="text-right">
            <nuxt-link class="block font-[800] text-jm-primary-green uppercase" to="/imprint">{{ t('imprint') }}
            </nuxt-link>
            <nuxt-link class="block font-[800] text-jm-primary-green uppercase" to="/privacy">{{ t('privacy') }}
            </nuxt-link>
          </div>
        </div>
      </UContainer>
