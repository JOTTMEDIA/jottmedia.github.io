...
const positionToClassOut = {
  ...
  center: 'absolute top-50 -translate-y-1/2 repeat-x bg-center w-full',
  centerLeft: 'absolute top-50 left-0 -translate-y-1/2 bg-no-repeat bg-contain bg-left-center',
  centerRight: 'absolute top-50 right-0 -translate-y-1/2 bg-no-repeat bg-contain bg-right-center',
